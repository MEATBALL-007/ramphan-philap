...
## รูปแบบ
เว็บแบบ **เปิดทีละหน้า (page deck)** เต็มจอ — กดปุ่ม “ถัดไป / ก่อนหน้า”, ปัดซ้ายขวา หรือกดลูกศรคีย์บอร์ด มีแถบความคืบหน้าด้านบน ออกแบบให้เด็กประถมปลาย–ม.ต้น อ่านง่าย (๑๕ หน้า)
...
- บทกลอนเด่นตามต้นฉบับ (๒ หน้า)
- คุณค่าของวรรณคดี ๓ ด้าน
- แบบทดสอบ ๕ ข้อ (ทีละข้อต่อหน้า พร้อมเฉลย)
- หน้าผลคะแนน + รับเกียรติบัตร
- แหล่งอ้างอิง
