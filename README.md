...
## รูปแบบ
**กิจกรรมแบบทดสอบ** แบบเปิดทีละหน้าเต็มจอ — กดปุ่ม “ถัดไป / ก่อนหน้า”, ปัดซ้ายขวา หรือกดลูกศรคีย์บอร์ด มีแถบความคืบหน้าด้านบน ออกแบบให้เด็กประถมปลาย–ม.ต้น เล่นง่าย (๗ หน้า)

## เนื้อหา (แต่ละหน้า)
- ปกกิจกรรม
- แบบทดสอบ ๕ ข้อ (ทีละข้อต่อหน้า แตะเลือกคำตอบ พร้อมเฉลยทันที)
- หน้าผลคะแนน + กรอกชื่อรับเกียรติบัตร (ดาวน์โหลด PNG)
